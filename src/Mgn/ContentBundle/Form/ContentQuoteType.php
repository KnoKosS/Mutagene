...
class ContentQuoteType extends AbstractType
{
  public function buildForm(FormBuilderInterface $builder, array $options)
  {
    $builder
      ...
      ->add('quote', 'textarea', array('required' => false))
      ->add('quoteName', 'text', array('required' => false))
      ->add('quoteLink', 'text', array('required' => false))
