...
class Category
{
    ...
    */
    ...
    /**
     * @ORM\OneToMany(targetEntity="Mgn\ArticleBundle\Entity\Article", mappedBy="category")
     */
    private $articles;
     ...
     * Add articles
     *
     * @param \Mgn\ArticleBundle\Entity\Article $articles
     * @return Category
     */
    public function addArticle(\Mgn\ArticleBundle\Entity\Article $articles)
    {
     ...
     * @param \Mgn\ArticleBundle\Entity\Article $articles
     */
    public function removeArticle(\Mgn\ArticleBundle\Entity\Article $articles)
    {
